...
float OtCircuitPinClass::getSample(size_t channel, size_t sample) {
	...
	if (attenuationFlag) {
		...
		return OtAudioUtilities::tuneCV(value, tuning);
...
void OtCircuitPinClass::setSample(size_t channel, size_t sample, float value) {
	if (attenuationFlag) {
		...
		audioBuffer->set(channel, sample, OtAudioUtilities::tuneCV(value, tuning));
...
void OtCircuitPinClass::setSamples(float value) {
	if (attenuationFlag) {
		...
		audioBuffer->clear(OtAudioUtilities::tuneCV(value, tuning));
