...
protected:
 ...
 public:
	...
	inline void calculateSizes() {
		...
		width2 = std::max(width2, OtUi::headerWidth("Low"));
		...
		width1 += spacing.x;
		width3 = std::max(width3, OtUi::headerWidth("Peak1"));
		...
		width1 += spacing.x;
		width4 = std::max(width4, OtUi::headerWidth("Peak2"));
		...
		width1 += spacing.x;
		width5 = std::max(width5, OtUi::headerWidth("Peak3"));
		...
		width1 += spacing.x;
		width6 = std::max(width6, OtUi::headerWidth("High"));
	...
	inline bool renderUI() {
		...
		bool changed = false;
		ImGui::BeginChild("Parametric EQ", ImVec2(width1, height1));
		ImGui::BeginChild("Low", ImVec2(width2, height2), ImGuiChildFlags_Borders);
		OtUi::header("Low");
		changed |= OtUi::knob("Level", &fHslider2, -40.0f, 40.0f, "%.1fdB");
		changed |= OtUi::knob("Freq", &fHslider1, 1.0f, 1000.0f, "%.0fhz");
		ImGui::EndChild();
		ImGui::SameLine();
		ImGui::BeginChild("Peak1", ImVec2(width3, height3), ImGuiChildFlags_Borders);
		OtUi::header("Peak1");
		...
		ImGui::EndChild();
		ImGui::SameLine();
		ImGui::BeginChild("Peak2", ImVec2(width4, height4), ImGuiChildFlags_Borders);
		OtUi::header("Peak2");
		...
		ImGui::EndChild();
		ImGui::SameLine();
		ImGui::BeginChild("Peak3", ImVec2(width5, height5), ImGuiChildFlags_Borders);
		OtUi::header("Peak3");
		...
		ImGui::EndChild();
		ImGui::SameLine();
		ImGui::BeginChild("High", ImVec2(width6, height6), ImGuiChildFlags_Borders);
		OtUi::header("High");
