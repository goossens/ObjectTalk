...
process = fi.low_shelf(LL, FL) : fi.peak_eq(LP1, FP1, BP1) : fi.peak_eq(LP2, FP2, BP2) : fi.peak_eq(LP3, FP3, BP3) : fi.high_shelf(LH, FH)
with{
	...
	Q1 = pq1_group(hslider("[2]Q[style:knob]", 40, 1, 1000, 0.1));
	BP1 = FP1 / Q1;
	...
	Q2 = pq_group2(hslider("[2]Q[style:knob]", 40, 1, 1000, 0.1));
	BP2 = FP2 / Q2;
	...
	Q3 = pq_group3(hslider("[2]Q[style:knob]", 40, 1, 1000, 0.1));
	BP3 = FP3 / Q3;
