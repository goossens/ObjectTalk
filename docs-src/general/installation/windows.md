ObjectTalk is supported on Windows 11 and Server 2025. There are 3 simple requirements
to get your machine ready for ObjectTalk development:

* Install Visual Studio 18 2025 (make sure you pick the "Desktop development with C++" option)
