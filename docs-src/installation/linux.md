...
on Ubuntu 24.04 Desktop. In practice, any distribution
...
To build the full version of ObjectTalk on Ubuntu 24.04
Desktop with GUI and IDE, run the following commands:

* Install additional software using **sudo apt-get install build-essential cmake ninja-build git glslang-tools xorg-dev libgl1-mesa-dev x11proto-core-dev libx11-dev libwayland-dev libxkbcommon-x11-dev**
