...
glm::vec2 OtErosion2::sample(glm::vec2 position, HeightConfig& height, ErosionConfig& erosion, int seed) {
...
//
//	OtErosion2::erosionFilter
//

OtErosion2::Erosion OtErosion2::erosionFilter(const glm::vec2 position, glm::vec3 heightAndSlope, float fadeTarget, ErosionConfig& erosion, int seed) {
...
//
//	OtErosion2::fractalNoise
//

glm::vec3 OtErosion2::fractalNoise(glm::vec2 position, float frequency, int octaves, float lacunarity, float gain, int seed) {
	glm::vec3 n{0.0f};
	auto na = 1.0f;
...
//
//	OtErosion2::phacelleNoise
//

glm::vec4 OtErosion2::phacelleNoise(glm::vec2 position, glm::vec2 normDir, float freq, float offset, float normalization, int seed) {
...
glm::vec3 OtErosion2::noised(int seed, glm::vec2 position) {
...
glm::vec2 OtErosion2::hash2(glm::vec2 x, int seed) {
...
//
//	OtErosion2::smoothStart
//

float OtErosion2::smoothStart(float t, float smoothing) {
...
float OtErosion2::powInv(float t, float power) {
...
float OtErosion2::easeOut(float t) {
