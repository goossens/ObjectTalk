...
public:
	...
	static constexpr Type stepOver = u8"\uf112";
	static constexpr Type stepOut = u8"\uf113";
	static constexpr Type stepInto = u8"\uf114";
...
private:
	static uint8_t fontData[27808];
	static constexpr size_t fontSize = 27808;
};
