...
public:
	...
	static constexpr const char* tuning = u8"\uf10d";
	...
	static constexpr const char* modSharkTooth = u8"\uf13f";
	...
	static constexpr const char* ffwd = u8"\uf15a";
