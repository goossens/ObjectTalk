...
//
//	OtDodecahedronPrimitive::OtDodecahedronPrimitive
//
...
//
//	OtDodecahedronPrimitive::renderUI
//

bool OtDodecahedronPrimitive::renderUI() {
	return OtPolyhedronPrimitive::renderUI();
}


//
//	OtDodecahedronPrimitive::serialize
//

nlohmann::json OtDodecahedronPrimitive::serialize(std::string* basedir) {
