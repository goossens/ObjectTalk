...
//
//	OtColorParser::toVec3
//

glm::vec3 OtColorParser::toVec3(const std::string& css) {
...
//
//	OtColorParser::toVec4
//

glm::vec4 OtColorParser::toVec4(const std::string& css) {
	OtRgbColor color = parse(css);
