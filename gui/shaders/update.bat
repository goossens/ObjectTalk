...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f normaled/shader.vs -o normaled/vs_dx9.h -i include --type vertex --platform windows -p vs_3_0 -O 3 --bin2c OtNormaledVS_dx9
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f normaled/shader.vs -o normaled/vs_dx11.h -i include --type vertex --platform windows -p vs_5_0 -O 3 --bin2c OtNormaledVS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f normaled/shader.fs -o normaled/fs_dx9.h -i include --type fragment --platform windows -p ps_3_0 -O 3 --bin2c OtNormaledFS_dx9
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f normaled/shader.fs -o normaled/fs_dx11.h -i include --type fragment --platform windows -p ps_5_0 -O 3 --bin2c OtNormaledFS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f normaled/instancing.vs -o normaled/vsi_dx9.h -i include --type vertex --platform windows -p vs_3_0 -O 3 --bin2c OtNormaledVSI_dx9
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f normaled/instancing.vs -o normaled/vsi_dx11.h -i include --type vertex --platform windows -p vs_5_0 -O 3 --bin2c OtNormaledVSI_dx11
