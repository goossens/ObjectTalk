...
inline size_t OtCodePointSize(std::string::const_iterator i) {
	if ((*i & 0x80) == 0) {
		return 1;
...
inline std::string::const_iterator OtCodePointGet(std::string::const_iterator i, int32_t* codeword) {
	if ((*i & 0x80) == 0) {
		*codeword = *i;
		i++;
...
inline std::string::iterator OtCodePointPut(std::string::iterator i, int32_t codeword) {
