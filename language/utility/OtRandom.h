...
inline float OtRandom(float num1, float num2) { return static_cast<float>(OtRandom(double(num1), double(num2))); }
inline float OtRandom(float num) { return static_cast<float>(OtRandom(0.0, double(num))); }
