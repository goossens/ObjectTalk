...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f deferred\OtDeferredAnimatedVS.glsl -o generated\deferred\OtDeferredAnimatedVS_dx11.h -i include --type vertex --platform windows --profile s_5_0 -O 3 --bin2c OtDeferredAnimatedVS_dx11
...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f filter\OtRgbaCurvesFS.glsl -o generated\filter\OtRgbaCurvesFS_dx11.h -i include --type fragment --platform windows --profile s_5_0 -O 3 --bin2c OtRgbaCurvesFS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f filter\OtRgbaFS.glsl -o generated\filter\OtRgbaFS_dx11.h -i include --type fragment --platform windows --profile s_5_0 -O 3 --bin2c OtRgbaFS_dx11
...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f generator\OtCheckerBoardCS.glsl -o generated\generator\OtCheckerBoardCS_dx11.h -i include --type compute --platform windows --profile s_5_0 -O 3 --bin2c OtCheckerBoardCS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f generator\OtColorWheelCS.glsl -o generated\generator\OtColorWheelCS_dx11.h -i include --type compute --platform windows --profile s_5_0 -O 3 --bin2c OtColorWheelCS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f generator\OtFbmCS.glsl -o generated\generator\OtFbmCS_dx11.h -i include --type compute --platform windows --profile s_5_0 -O 3 --bin2c OtFbmCS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f generator\OtRenderLightCS.glsl -o generated\generator\OtRenderLightCS_dx11.h -i include --type compute --platform windows --profile s_5_0 -O 3 --bin2c OtRenderLightCS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f generator\OtTileableFbmCS.glsl -o generated\generator\OtTileableFbmCS_dx11.h -i include --type compute --platform windows --profile s_5_0 -O 3 --bin2c OtTileableFbmCS_dx11
...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f highlight\OtSelectAnimatedVS.glsl -o generated\highlight\OtSelectAnimatedVS_dx11.h -i include --type vertex --platform windows --profile s_5_0 -O 3 --bin2c OtSelectAnimatedVS_dx11
...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f occlusion\OtOcclusionAnimatedVS.glsl -o generated\occlusion\OtOcclusionAnimatedVS_dx11.h -i include --type vertex --platform windows --profile s_5_0 -O 3 --bin2c OtOcclusionAnimatedVS_dx11
...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f picking\OtPickingAnimatedVS.glsl -o generated\picking\OtPickingAnimatedVS_dx11.h -i include --type vertex --platform windows --profile s_5_0 -O 3 --bin2c OtPickingAnimatedVS_dx11
...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f shadow\OtShadowAnimatedVS.glsl -o generated\shadow\OtShadowAnimatedVS_dx11.h -i include --type vertex --platform windows --profile s_5_0 -O 3 --bin2c OtShadowAnimatedVS_dx11
...
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f Terrain\OtTerrainSimpleVS.glsl -o generated\Terrain\OtTerrainSimpleVS_dx11.h -i include --type vertex --platform windows --profile s_5_0 -O 3 --bin2c OtTerrainSimpleVS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f Terrain\OtTerrainVS.glsl -o generated\Terrain\OtTerrainVS_dx11.h -i include --type vertex --platform windows --profile s_5_0 -O 3 --bin2c OtTerrainVS_dx11
%HOMEDRIVE%%HOMEPATH%\bin\shaderc -f Terrain\OtTerrainFS.glsl -o generated\Terrain\OtTerrainFS_dx11.h -i include --type fragment --platform windows --profile s_5_0 -O 3 --bin2c OtTerrainFS_dx11
