...
// texture samplers
SAMPLER2D(s_waterNormalMapTexture, 0);
...
void main() {
	...
	vec4 noise =
		texture2D(s_waterNormalMapTexture, uv1) +
		texture2D(s_waterNormalMapTexture, uv2) +
		texture2D(s_waterNormalMapTexture, uv3) +
		texture2D(s_waterNormalMapTexture, uv4);
